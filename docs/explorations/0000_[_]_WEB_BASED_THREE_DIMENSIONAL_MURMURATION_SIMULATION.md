...
- [x] Add explicit attractor speed and radius controls so the main volume can visibly travel through the scene.
...
- [x] Add particle opacity and subtle rim falloff controls so dense clumps remain legible.
